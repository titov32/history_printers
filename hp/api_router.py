...
@hp_api_router.get("/cartridge/{cartridge_id}") #, response_model=schemas.Cartridge
...
@hp_api_router.post("/users/{user_id}/items/", response_model=schemas.Item)
...
@hp_api_router.get("/items/")#, response_model=list[schemas.Item])
